...
obesity_dummy$Gender <- dummy(obesity$Gender, sep = "_")

#family_history 1=yes 0=no
obesity_dummy <- cbind( obesity[1:4], dummy(obesity$family_history, sep = "_"), obesity[6:17])
...
lm_height <- lm(Height~ .,data = obesity_lm_dum)
summary(lm_height)
plot(lm_height)
