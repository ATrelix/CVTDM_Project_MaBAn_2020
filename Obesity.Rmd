...
Ommited variable bias (income level correlated with MTRANS, and others)

QUestions not very precise (the alcohol one...)

Compare project proposal with what we actually did! Explain problems we encountered (like with boosting), and why we changed the outcome variable to weight!
